...
import (
	...
	"github.com/M1steryO/RelocatorEvents/users/internal/models/token"
...
func GenerateToken(user token.UserInfo, secretKey []byte, duration time.Duration) (string, error) {
	now := time.Now()
