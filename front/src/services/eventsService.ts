    ...
    async getEvent(id: number): Promise<{ event: Event }> {
        ...
        if (responseData.event) {
            ...
            event = {
                ...
                rating: responseData.rating ?? undefined,
                reviews_count: responseData.reviews_count ?? undefined,
                ratings_count: responseData.ratings_count ?? undefined,
                min_age: responseData.min_age,
                seats_available: responseData.seats_available ?? undefined,
