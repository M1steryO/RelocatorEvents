...
type CheckRequest struct {
	...
	AccessToken      string                 `protobuf:"bytes,1,opt,name=access_token,json=accessToken,proto3" json:"access_token,omitempty"`
	RefreshToken     string                 `protobuf:"bytes,2,opt,name=refresh_token,json=refreshToken,proto3" json:"refresh_token,omitempty"`
	TelegramInitData string                 `protobuf:"bytes,3,opt,name=telegram_init_data,json=telegramInitData,proto3" json:"telegram_init_data,omitempty"`
	unknownFields    protoimpl.UnknownFields
	sizeCache        protoimpl.SizeCache
}
...
func (x *CheckRequest) GetTelegramInitData() string {
	if x != nil {
...
func (x *CheckResponse) GetAccessToken() string {
	if x != nil {
		return x.AccessToken
	}
	return ""
...
func (x *CheckResponse) GetUserId() int64 {
	if x != nil {
		return x.UserId
	}
	return 0
...
const file_auth_v1_messages_proto_rawDesc = "" +
	"\n" +
	"\x16auth/v1/messages.proto\x12/github.com.M1steryO.RelocatorEvents.auth.api.v1\x1a\x1cgoogle/api/annotations.proto\"@\n" +
	...
	"\x12telegram_init_data\x18\x03 \x01(\tR\x10telegramInitData\"p\n" +
	"\rCheckResponse\x12!\n" +
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12#\n" +
	...
	"\faccess_token\x18\x01 \x01(\tR\vaccessToken\x12#\n" +
	"\rrefresh_token\x18\x02 \x01(\tR\frefreshTokenBEZCgithub.com/M1steryO/RelocatorEvents/auth/pkg/api/proto/auth/v1;authb\x06proto3"
...
var file_auth_v1_messages_proto_msgTypes = make([]protoimpl.MessageInfo, 10)
var file_auth_v1_messages_proto_goTypes = []any{
	...
	(*LoginResponse)(nil),           // 1: github.com.M1steryO.RelocatorEvents.auth.api.v1.LoginResponse
	(*CheckRequest)(nil),            // 2: github.com.M1steryO.RelocatorEvents.auth.api.v1.CheckRequest
	(*CheckResponse)(nil),           // 3: github.com.M1steryO.RelocatorEvents.auth.api.v1.CheckResponse
	(*TelegramLoginRequest)(nil),    // 4: github.com.M1steryO.RelocatorEvents.auth.api.v1.TelegramLoginRequest
	(*TelegramLoginReponse)(nil),    // 5: github.com.M1steryO.RelocatorEvents.auth.api.v1.TelegramLoginReponse
	(*GetRefreshTokenRequest)(nil),  // 6: github.com.M1steryO.RelocatorEvents.auth.api.v1.GetRefreshTokenRequest
	(*GetRefreshTokenResponse)(nil), // 7: github.com.M1steryO.RelocatorEvents.auth.api.v1.GetRefreshTokenResponse
	(*GetAccessTokenRequest)(nil),   // 8: github.com.M1steryO.RelocatorEvents.auth.api.v1.GetAccessTokenRequest
