...
func (m *CheckRequest) validate(all bool) error {
	...
	// no validation rules for TelegramInitData
...
// Validate checks the field values on TelegramLoginRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *TelegramLoginRequest) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on TelegramLoginRequest with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// TelegramLoginRequestMultiError, or nil if none found.
func (m *TelegramLoginRequest) ValidateAll() error {
	return m.validate(true)
}

func (m *TelegramLoginRequest) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return TelegramLoginRequestMultiError(errors)
	}

	return nil
}

// TelegramLoginRequestMultiError is an error wrapping multiple validation
// errors returned by TelegramLoginRequest.ValidateAll() if the designated
// constraints aren't met.
type TelegramLoginRequestMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m TelegramLoginRequestMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m TelegramLoginRequestMultiError) AllErrors() []error { return m }

// TelegramLoginRequestValidationError is the validation error returned by
// TelegramLoginRequest.Validate if the designated constraints aren't met.
type TelegramLoginRequestValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e TelegramLoginRequestValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e TelegramLoginRequestValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e TelegramLoginRequestValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e TelegramLoginRequestValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e TelegramLoginRequestValidationError) ErrorName() string {
	return "TelegramLoginRequestValidationError"
}

// Error satisfies the builtin error interface
func (e TelegramLoginRequestValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sTelegramLoginRequest.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = TelegramLoginRequestValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = TelegramLoginRequestValidationError{}

// Validate checks the field values on TelegramLoginReponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *TelegramLoginReponse) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on TelegramLoginReponse with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// TelegramLoginReponseMultiError, or nil if none found.
func (m *TelegramLoginReponse) ValidateAll() error {
	return m.validate(true)
}

func (m *TelegramLoginReponse) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return TelegramLoginReponseMultiError(errors)
	}

	return nil
}

// TelegramLoginReponseMultiError is an error wrapping multiple validation
// errors returned by TelegramLoginReponse.ValidateAll() if the designated
// constraints aren't met.
type TelegramLoginReponseMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m TelegramLoginReponseMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m TelegramLoginReponseMultiError) AllErrors() []error { return m }

// TelegramLoginReponseValidationError is the validation error returned by
// TelegramLoginReponse.Validate if the designated constraints aren't met.
type TelegramLoginReponseValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e TelegramLoginReponseValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e TelegramLoginReponseValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e TelegramLoginReponseValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e TelegramLoginReponseValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e TelegramLoginReponseValidationError) ErrorName() string {
	return "TelegramLoginReponseValidationError"
}

// Error satisfies the builtin error interface
func (e TelegramLoginReponseValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sTelegramLoginReponse.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = TelegramLoginReponseValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = TelegramLoginReponseValidationError{}
