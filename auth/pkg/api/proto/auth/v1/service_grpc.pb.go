...
const (
	AuthService_Login_FullMethodName           = "/github.com.M1steryO.RelocatorEvents.auth.api.v1.AuthService/Login"
	AuthService_TelegramLogin_FullMethodName   = "/github.com.M1steryO.RelocatorEvents.auth.api.v1.AuthService/TelegramLogin"
	AuthService_Check_FullMethodName           = "/github.com.M1steryO.RelocatorEvents.auth.api.v1.AuthService/Check"
	AuthService_GetRefreshToken_FullMethodName = "/github.com.M1steryO.RelocatorEvents.auth.api.v1.AuthService/GetRefreshToken"
	AuthService_GetAccessToken_FullMethodName  = "/github.com.M1steryO.RelocatorEvents.auth.api.v1.AuthService/GetAccessToken"
)
...
func (c *authServiceClient) TelegramLogin(ctx context.Context, in *TelegramLoginRequest, opts ...grpc.CallOption) (*TelegramLoginReponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func (UnimplementedAuthServiceServer) TelegramLogin(context.Context, *TelegramLoginRequest) (*TelegramLoginReponse, error) {
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "github.com.M1steryO.RelocatorEvents.auth.api.v1.AuthService",
