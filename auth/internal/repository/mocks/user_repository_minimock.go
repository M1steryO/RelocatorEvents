...
type UserRepositoryMock struct {
	...
	funcCreate          func(ctx context.Context, user *modelRepo.User) (i1 int64, err error)
	funcCreateOrigin    string
	inspectFuncCreate   func(ctx context.Context, user *modelRepo.User)
	afterCreateCounter  uint64
	beforeCreateCounter uint64
	CreateMock          mUserRepositoryMockCreate

	funcCreateLog          func(ctx context.Context, userId int64, action string) (err error)
	funcCreateLogOrigin    string
	inspectFuncCreateLog   func(ctx context.Context, userId int64, action string)
...
func (mmCreate *mUserRepositoryMockCreate) Expect(ctx context.Context, user *modelRepo.User) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) ExpectUserParam2(user *modelRepo.User) *mUserRepositoryMockCreate {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *mUserRepositoryMockCreate) Inspect(f func(ctx context.Context, user *modelRepo.User)) *mUserRepositoryMockCreate {
...
func (mmCreate *mUserRepositoryMockCreate) Set(f func(ctx context.Context, user *modelRepo.User) (i1 int64, err error)) *UserRepositoryMock {
	if mmCreate.defaultExpectation != nil {
...
// Then helper
func (mmCreate *mUserRepositoryMockCreate) When(ctx context.Context, user *modelRepo.User) *UserRepositoryMockCreateExpectation {
	if mmCreate.mock.funcCreate != nil {
		mmCreate.mock.t.Fatalf("UserRepositoryMock.Create mock is already set by Set")
	}
...
func (mmCreate *UserRepositoryMock) Create(ctx context.Context, user *modelRepo.User) (i1 int64, err error) {
...
type UserRepositoryMockCreateLogExpectation struct {
	...
	paramPtrs          *UserRepositoryMockCreateLogParamPtrs
	expectationOrigins UserRepositoryMockCreateLogExpectationOrigins
...
// UserRepositoryMockCreateLogParamPtrs contains pointers to parameters of the UserRepository.CreateLog
type UserRepositoryMockCreateLogParamPtrs struct {
	ctx    *context.Context
	userId *int64
	action *string
}
...
// UserRepositoryMockCreateLogOrigins contains origins of expectations of the UserRepository.CreateLog
type UserRepositoryMockCreateLogExpectationOrigins struct {
	origin       string
	originCtx    string
	originUserId string
	originAction string
...
// It is NOT RECOMMENDED to use this option unless you really need it, as default behaviour helps to
// catch the problems when the expected method call is totally skipped during test run.
func (mmCreateLog *mUserRepositoryMockCreateLog) Optional() *mUserRepositoryMockCreateLog {
	mmCreateLog.optional = true
	return mmCreateLog
}

// Expect sets up expected params for UserRepository.CreateLog
func (mmCreateLog *mUserRepositoryMockCreateLog) Expect(ctx context.Context, userId int64, action string) *mUserRepositoryMockCreateLog {
	...
	if mmCreateLog.defaultExpectation.paramPtrs != nil {
		mmCreateLog.mock.t.Fatalf("UserRepositoryMock.CreateLog mock is already set by ExpectParams functions")
	}

	mmCreateLog.defaultExpectation.params = &UserRepositoryMockCreateLogParams{ctx, userId, action}
...
// ExpectCtxParam1 sets up expected param ctx for UserRepository.CreateLog
func (mmCreateLog *mUserRepositoryMockCreateLog) ExpectCtxParam1(ctx context.Context) *mUserRepositoryMockCreateLog {
	if mmCreateLog.mock.funcCreateLog != nil {
		mmCreateLog.mock.t.Fatalf("UserRepositoryMock.CreateLog mock is already set by Set")
	}
	...
	if mmCreateLog.defaultExpectation.params != nil {
		mmCreateLog.mock.t.Fatalf("UserRepositoryMock.CreateLog mock is already set by Expect")
	}

	if mmCreateLog.defaultExpectation.paramPtrs == nil {
		mmCreateLog.defaultExpectation.paramPtrs = &UserRepositoryMockCreateLogParamPtrs{}
	}
...
// ExpectUserIdParam2 sets up expected param userId for UserRepository.CreateLog
func (mmCreateLog *mUserRepositoryMockCreateLog) ExpectUserIdParam2(userId int64) *mUserRepositoryMockCreateLog {
	if mmCreateLog.mock.funcCreateLog != nil {
		mmCreateLog.mock.t.Fatalf("UserRepositoryMock.CreateLog mock is already set by Set")
	}
	...
	mmCreateLog.defaultExpectation.paramPtrs.userId = &userId
	mmCreateLog.defaultExpectation.expectationOrigins.originUserId = minimock.CallerInfo(1)

	return mmCreateLog
}

// ExpectActionParam3 sets up expected param action for UserRepository.CreateLog
func (mmCreateLog *mUserRepositoryMockCreateLog) ExpectActionParam3(action string) *mUserRepositoryMockCreateLog {
	if mmCreateLog.mock.funcCreateLog != nil {
		mmCreateLog.mock.t.Fatalf("UserRepositoryMock.CreateLog mock is already set by Set")
	}
	...
	mmCreateLog.defaultExpectation.paramPtrs.action = &action
	mmCreateLog.defaultExpectation.expectationOrigins.originAction = minimock.CallerInfo(1)

	return mmCreateLog
}

// Inspect accepts an inspector function that has same arguments as the UserRepository.CreateLog
func (mmCreateLog *mUserRepositoryMockCreateLog) Inspect(f func(ctx context.Context, userId int64, action string)) *mUserRepositoryMockCreateLog {
...
func (mmCreateLog *mUserRepositoryMockCreateLog) Set(f func(ctx context.Context, userId int64, action string) (err error)) *UserRepositoryMock {
	if mmCreateLog.defaultExpectation != nil {
...
// Then helper
func (mmCreateLog *mUserRepositoryMockCreateLog) When(ctx context.Context, userId int64, action string) *UserRepositoryMockCreateLogExpectation {
	if mmCreateLog.mock.funcCreateLog != nil {
		mmCreateLog.mock.t.Fatalf("UserRepositoryMock.CreateLog mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockCreateLogExpectation{
		...
		params:             &UserRepositoryMockCreateLogParams{ctx, userId, action},
		expectationOrigins: UserRepositoryMockCreateLogExpectationOrigins{origin: minimock.CallerInfo(1)},
	}
...
// Times sets number of times UserRepository.CreateLog should be invoked
func (mmCreateLog *mUserRepositoryMockCreateLog) Times(n uint64) *mUserRepositoryMockCreateLog {
	if n == 0 {
		mmCreateLog.mock.t.Fatalf("Times of UserRepositoryMock.CreateLog mock can not be zero")
	}
...
func (mmCreateLog *mUserRepositoryMockCreateLog) invocationsDone() bool {
...
// CreateLog implements mm_repository.UserRepository
func (mmCreateLog *UserRepositoryMock) CreateLog(ctx context.Context, userId int64, action string) (err error) {
	...
	if mmCreateLog.inspectFuncCreateLog != nil {
		mmCreateLog.inspectFuncCreateLog(ctx, userId, action)
	}

	mm_params := UserRepositoryMockCreateLogParams{ctx, userId, action}
	...
	if mmCreateLog.CreateLogMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockCreateLogParams{ctx, userId, action}

		if mm_want_ptrs != nil {

			if mm_want_ptrs.ctx != nil && !minimock.Equal(*mm_want_ptrs.ctx, mm_got.ctx) {
				mmCreateLog.t.Errorf("UserRepositoryMock.CreateLog got unexpected parameter ctx, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
			...
			if mm_want_ptrs.userId != nil && !minimock.Equal(*mm_want_ptrs.userId, mm_got.userId) {
				mmCreateLog.t.Errorf("UserRepositoryMock.CreateLog got unexpected parameter userId, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreateLog.CreateLogMock.defaultExpectation.expectationOrigins.originUserId, *mm_want_ptrs.userId, mm_got.userId, minimock.Diff(*mm_want_ptrs.userId, mm_got.userId))
			}

			if mm_want_ptrs.action != nil && !minimock.Equal(*mm_want_ptrs.action, mm_got.action) {
				mmCreateLog.t.Errorf("UserRepositoryMock.CreateLog got unexpected parameter action, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
					mmCreateLog.CreateLogMock.defaultExpectation.expectationOrigins.originAction, *mm_want_ptrs.action, mm_got.action, minimock.Diff(*mm_want_ptrs.action, mm_got.action))
			}

		} else if mm_want != nil && !minimock.Equal(*mm_want, mm_got) {
			mmCreateLog.t.Errorf("UserRepositoryMock.CreateLog got unexpected parameters, expected at\n%s:\nwant: %#v\n got: %#v%s\n",
	...
	if mmCreateLog.funcCreateLog != nil {
		return mmCreateLog.funcCreateLog(ctx, userId, action)
	}
	mmCreateLog.t.Fatalf("Unexpected call to UserRepositoryMock.CreateLog. %v %v %v", ctx, userId, action)
	return
}
...
func (m *UserRepositoryMock) MinimockCreateLogInspect() {
	for _, e := range m.CreateLogMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Errorf("Expected call to UserRepositoryMock.CreateLog at\n%s with params: %#v", e.expectationOrigins.origin, *e.params)
		}
	}
	...
	if !m.CreateLogMock.invocationsDone() && afterCreateLogCounter > 0 {
		m.t.Errorf("Expected %d calls to UserRepositoryMock.CreateLog at\n%s but found %d calls",
