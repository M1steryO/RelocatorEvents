...
const file_reviews_proto_rawDesc = "" +
	...
	"storageKey\x123\n" +
	"\x04type\x18\x02 \x01(\x0e2\x15.reviews_v1.MediaTypeB\b\xfaB\x05\x82\x01\x02\x10\x01R\x04type\"\xf3\x02\n" +
	"\x06Review\x12\x1f\n" +
	...
	"\x04text\x18\x04 \x01(\tB\b\xfaB\x05r\x03\x18\xc8\x01R\x04text\x12;\n" +
