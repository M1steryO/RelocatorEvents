...
const file_reviews_proto_rawDesc = "" +
	...
	"storageKey\x123\n" +
	"\x04type\x18\x02 \x01(\x0e2\x15.reviews_v1.MediaTypeB\b\xfaB\x05\x82\x01\x02\x10\x01R\x04type\"\xf5\x02\n" +
	"\x06Review\x12\x1f\n" +
	...
	"advantages\x12-\n" +
	"\rdisadvantages\x18\x03 \x01(\tB\a\xfaB\x04r\x02\x18dR\rdisadvantages\x12\x1e\n" +
